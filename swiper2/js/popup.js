$(document).ready(function(){
    ...
    /* 
    1. class명 상태에 따라 선택자를 완전히 다르게 해서 이벤트를 두번 주는 경우. 
    2. 하나의 이벤트로 if문을 써서 현재 play상태인지 stop상태인지 구분해서 적용하는 경우.
    */

    $('.popup .btn_stop').on('click', function(){
        if($(this).hasClass('play') == true){ //만약에 현재 play클래스를 가지고 있다면 (일시정지 중)
